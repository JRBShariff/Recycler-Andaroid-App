...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ImageViewHolder> {
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.itemm_layout,parent,false);
    ...
    public void onBindViewHolder(ImageViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(uploadCurrent.getImg_poster()).into(holder.imageView);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
        ...
        public ImageViewHolder(View itemView) {
            super(itemView);
            mTvName = itemView.findViewById(R.id.tv1);
            mTvPhone = itemView.findViewById(R.id.tv2);
